    ...
    <div class="row">
        <div class="col-md-12">
            <div class="well login-box">
                <form  name="enterUser" method="post" action="Controller?command=RegistrationUser" class="form-signin">
                    <legend><%= RB.getString("register") %></legend>
                    <div class="form-group">
                        <label for="username-email"><%= RB.getString("name") %></label>
                        <input value='' name="name" id="name" placeholder="Enter your name" type="text" class="form-control" required autofocus />
                    </div>
                   <div class="form-group">
                        <label for="username-email"><%= RB.getString("email") %> </label>
                        <input value='' name="email" id="username-email" placeholder="Enter your E-mail" type="email" class="form-control" required/>
                    </div>                   
                    <div class="form-group">
                        <label for="password"><%= RB.getString("password") %></label>
                        <input id="password" name="password" value='' placeholder="Enter your password" type="password" class="form-control" required/>
                    </div>
