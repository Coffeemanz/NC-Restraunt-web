    ...
    <div class="row">
        <div class="col-md-12">
            <div class="well login-box">
                <form name="loginUser" method="post" action="Controller?command=LoginUser" class="form-signin">
                <input type="hidden" name="command" value="LoginUser">
                    ...
                    <div class="form-group">
                        ...
                        <input value='' id="username-email" name="email" placeholder=<%= RB.getString("enter") %> type="email"  class="form-control" required autofocus/>
                    </div>
                    <div class="form-group">
                        <label for="password"><%= RB.getString("password") %></label>
                        <input id="password" value='' name="password" placeholder=<%= RB.getString("enter") %> type="password" class="form-control" required/>
                    </div>
